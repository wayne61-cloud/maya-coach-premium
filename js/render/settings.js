...
function renderProfileTab(profile, weightEvolution) {
  return `
    <div class="card settings-section card-profile glow-violet">
      <div class="settings-section-head">
        <div>
          <div class="eyebrow">Page profil</div>
          <h3>Profil athlète</h3>
          <p class="muted">Ta vraie fiche personnelle. C’est ici que l’app comprend qui tu es et comment mieux te coacher.</p>
        </div>
        <span class="pill pill-calm">${escapeHtml(weightEvolution.currentWeightKg ? `${weightEvolution.currentWeightKg} kg` : "à compléter")}</span>
      </div>
...
function renderCoachTab(aiRuntime) {
  return `
    <div class="card settings-section card-calm glow-blue">
      <div class="settings-section-head">
        <div>
          <div class="eyebrow">Coach IA</div>
          <h3>Réglages IA</h3>
          <p class="muted">La page génération reste simple. Tous les réglages cloud et web sont concentrés ici.</p>
        </div>
...
function renderSyncTab(syncRuntime, diagnostics) {
  return `
    <div class="card settings-section card-success glow-green">
      <div class="settings-section-head">
        <div>
          <div class="eyebrow">Sync et notifications</div>
          <h3>Continuité multi-appareils</h3>
          <p class="muted">Les options de sync et les notifications sont sorties de l’accueil pour garder une home plus nette.</p>
        </div>
...
function renderAppTab(diagnostics, stats, recommendations) {
  return `
    <div class="card settings-section card-alert glow-coral">
      <div class="settings-section-head">
        <div>
...
export function renderSettings(node) {
  ...
  node.innerHTML = `
    <div class="section settings-page">
      <div class="card settings-hero card-calm glow-blue">
        <div class="eyebrow">Pôle paramètres</div>
        <h2>Paramètres, profil et pilotage</h2>
        <p class="muted">Une vraie page dédiée. Le profil athlète, le coach IA, la sync et la santé produit sont séparés en vues claires.</p>
        <div class="settings-summary-grid">
          <div class="summary-chip summary-chip-blue">
