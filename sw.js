const CACHE_NAME = "maya-coach-shell-v11-20260331-5";
const APP_SHELL = [
  "./",
  "./index.html",
  "./index.html?v=20260331-5",
  "./styles.css?v=20260331-5",
  "./manifest.webmanifest?v=20260331-5",
  "./js/main.js?v=20260331-5"
];
...
self.addEventListener("notificationclick", (event) => {
  ...
  event.waitUntil(
    clients.matchAll({ type: "window", includeUncontrolled: true }).then((windowClients) => {
      ...
      return clients.openWindow("./index.html?v=20260331-5");
    })
  );
});
